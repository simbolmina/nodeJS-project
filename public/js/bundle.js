      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') location.reload(true); //true will force the page from server, not the browser, otherwise browser might keep token and infos
...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2ltYm9sbWluYSIsImEiOiJjbDI3Y3o1cmwwN2NxM2xxbDlmdWh3bGk4In0.tG73WvLC0rOL-Nk61Q7O5Q';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updateMyPassword' : 'http://localhost:3000/api/v1/users/updateMe'; //   type === 'password'
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51Ks2MeBvEMVy1zPIHj2fVXQSrk7HqcW8Ba1N5uPkhWmI1WaGciiC0kE6xdWIRG0E6d2Ba2GGFxCCX2Iy8BovS9K700Fy7gh1wj'); //1 - get checkout session from API
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // const locations = document.getElementById('map').dataset.location;
  // console.log(locations);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            //we await updateSettings and then manipulate dom to clear
